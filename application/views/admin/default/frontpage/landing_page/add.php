    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">New Landing Page</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo site_url('admin/frontpage/add_landing_page')?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
