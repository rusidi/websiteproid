                    ...
                    <ul class="sidebar-menu">
                        ...
                        <?php if(in_array('admin',$current_groups)):?>
                            <li class="active">
                             ...
                             <li class="treeview <?php echo ($parent_menu == 'frontpage')? 'active' : '' ?>">
                                <a href="#">
                                    <i class="fa fa-file"></i> <span>Front Page</span>
                                    <i class="fa fa-angle-left pull-right"></i>
                                </a>
                                <ul class="treeview-menu" <?php echo ($parent_menu == 'user')? 'style="display:block"' : 'style="display:none"' ?>>
                                    <li><a href="<?php echo site_url('admin/frontpage/social_media')?>"><i class="fa fa-angle-double-right"></i> Social Media</a></li>
                                    <li><a href="<?php echo site_url('admin/frontpage/landing_page')?>"><i class="fa fa-angle-double-right"></i> Landing Page</a></li>
